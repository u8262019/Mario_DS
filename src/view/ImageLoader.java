...
public class ImageLoader {
	...
	public BufferedImage[] getLeftFrames2(int marioForm2) {
		BufferedImage[] leftFrames2 = new BufferedImage[5];
		int col = 1;
		int width = 52, height = 48;

		if (marioForm2 == 1) { // super mario
			col = 4;
			width = 48;
			height = 96;
		} else if (marioForm2 == 2) { // fire mario
			col = 7;
			width = 48;
			height = 96;
		}
		...
		for (int i = 0; i < 5; i++) {
			leftFrames2[i] = marioForms2.getSubimage((col - 1) * width, (i) * height, width, height);
		}
		return leftFrames2;
	}

	public BufferedImage[] getRightFrames2(int marioForm2) {
		BufferedImage[] rightFrames2 = new BufferedImage[5];
		int col = 2;
		int width = 52, height = 48;
		...
		for (int i = 0; i < 5; i++) {
			rightFrames2[i] = marioForms2.getSubimage((col - 1) * width, (i) * height, width, height);
		}
		return rightFrames2;
	}
